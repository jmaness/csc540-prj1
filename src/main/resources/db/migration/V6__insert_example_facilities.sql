...
insert into addresses (id, num, street, city, state, zip, country) values (1, 2650, 'Wolf Village Way Box 7220', 'Raleigh', 'NC', '27695', 'US');
...
insert into addresses (id, num, street, city, state, zip, country) values (2, 2500, 'Sacramento', 'Santa Cruz', 'CA', '90021', 'US');
...
insert into addresses (3, id, num, street, city, state, zip, country) values (489, 'First Avenue', 'New York', 'NY', '10001', 'US');
...
insert into addresses (id, num, street, city, state, zip, country) values (4, 100, 'UNC Street', 'Chapel Hill', 'North Carolina', '27600', 'US');
insert into facilities (name, capacity, classification_code, address_id) values ('UNC Hospital', 500, '01', 4);
insert into addresses (id, num, street, city, state, zip, country) values (5, 200, 'Duke Street', 'Durham', 'North Carolina', '27550', 'US');
insert into facilities (name, capacity, classification_code, address_id) values ('Duke Hospital', 500, '01', 5);
insert into addresses (id, num, street, city, state, zip, country) values (6, 300, 'NCSU Street', 'Raleigh', 'North Carolina', '27500', 'US');
