...
/* old data */
insert into departments (code, name, type, facility_id) values ('head', 'Department of Head', 'Medical', 2003);
insert into addresses (num, street, city, state, country) values (400, 'Sad Boy Ln', 'Durham', 'NC', 'US');
insert into staff (first_name, last_name, designation, hire_date, address_id, facility_id, primary_department_code) values ('Logab', 'Willard', 'Medical', DATE '2019-11-05', 4, 2003, 'head');
